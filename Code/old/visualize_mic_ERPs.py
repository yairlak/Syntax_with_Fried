...
parser.add_argument('-c', '--channel', type=int, action='append', default=[0], help='Which channels to analyze')
parser.add_argument('-b', '--block', type=int, action='append', default=[2, 4, 6], help='Which blocks to analyze')
parser.add_argument('-n', '--comparison', type=int, action='append', default=[1], help='Which comparisons from the paragism to contrast')
