...
parser.add_argument('-k', '--picks', action='append', default=[[40], [1]], help='List of lists (per patient) of channels to pick. Either a string ("all" (for all channels) or roi (e.g., "STG") or channel numbers as integers')
