...
parser.add_argument('-filename', default=[], help='Input filename (if empty list [] then will be assigned based on patient name)')
...
for ch, ch_name in enumerate(epochsTFR.ch_names):
    ...
    power_ave = power_ave / np.std(power_ave) 
