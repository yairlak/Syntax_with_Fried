function times_CSC = rm_range_min_spikes(times_CSC, cl, range_t, range_y)
% rm_range_min_spikes    Remove spikes whose minimum in a certain part of the
...
min_spikes = min(times_CSC.spikes(:, range_t(1):range_t(2)), [], 2);
f = find((times_CSC.cluster_class(:, 1) == cl) & (min_spikes >= range_y(1)) &...
         (min_spikes <= range_y(2)));
