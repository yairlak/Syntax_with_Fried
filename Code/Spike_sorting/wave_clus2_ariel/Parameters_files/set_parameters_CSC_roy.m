% #### Hagar Correction ####
function par=set_parameters(sr,filename,handles,timetotal)
% function par=set_parameters(sr,filename,handles)
if nargin < 4, timetotal = 3000; fprintf(1,'Warning: the timetotal parameter was not initialized, use a 3000sec default\n');, end;
...
par.ref = floor(1.5 *sr/1000);       % minimum refractory period (in ms)
