...
set SRC_DIR = /home/lab/yairlak/Documents/MATLAB/phonemeTIMIT/Build_FeatureMat_for_LASSO
...
foreach DIALECT (${DIALECT})
         set parmstr = TIMIT_DIALECT${DIALECT}
         ...
         echo "main_build_FeatureMat_SUM_MFCC;" >> $filename
